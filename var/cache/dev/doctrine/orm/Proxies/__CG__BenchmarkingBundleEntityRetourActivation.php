 ...
 */
class RetourActivation extends \BenchmarkingBundle\Entity\RetourActivation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BenchmarkingBundle\\Entity\\RetourActivation' . "\0" . 'id', '' . "\0" . 'BenchmarkingBundle\\Entity\\RetourActivation' . "\0" . 'typeRetourActivation', '' . "\0" . 'BenchmarkingBundle\\Entity\\RetourActivation' . "\0" . 'image', '' . "\0" . 'BenchmarkingBundle\\Entity\\RetourActivation' . "\0" . 'fonctions'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RetourActivation $proxy) {
    ...
    public function setTypeRetourActivation(\BenchmarkingBundle\Entity\TypeRetourActivation $typeRetourActivation)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypeRetourActivation', [$typeRetourActivation]);

        return parent::setTypeRetourActivation($typeRetourActivation);
    }
    ...
    public function getTypeRetourActivation()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTypeRetourActivation', []);

        return parent::getTypeRetourActivation();
    }
