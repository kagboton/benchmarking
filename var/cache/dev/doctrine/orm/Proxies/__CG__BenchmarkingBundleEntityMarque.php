 ...
 */
class Marque extends \BenchmarkingBundle\Entity\Marque implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BenchmarkingBundle\\Entity\\Marque' . "\0" . 'id', '' . "\0" . 'BenchmarkingBundle\\Entity\\Marque' . "\0" . 'nom', '' . "\0" . 'BenchmarkingBundle\\Entity\\Marque' . "\0" . 'vehicules'];
        }
