 ...
 */
class Segment extends \BenchmarkingBundle\Entity\Segment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BenchmarkingBundle\\Entity\\Segment' . "\0" . 'id', '' . "\0" . 'BenchmarkingBundle\\Entity\\Segment' . "\0" . 'nom', '' . "\0" . 'BenchmarkingBundle\\Entity\\Segment' . "\0" . 'description', '' . "\0" . 'BenchmarkingBundle\\Entity\\Segment' . "\0" . 'vehicules'];
        }
