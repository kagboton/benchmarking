 ...
 */
class Motorisation extends \BenchmarkingBundle\Entity\Motorisation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BenchmarkingBundle\\Entity\\Motorisation' . "\0" . 'id', '' . "\0" . 'BenchmarkingBundle\\Entity\\Motorisation' . "\0" . 'nom', '' . "\0" . 'BenchmarkingBundle\\Entity\\Motorisation' . "\0" . 'description', '' . "\0" . 'BenchmarkingBundle\\Entity\\Motorisation' . "\0" . 'vehicules'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Motorisation $proxy) {
