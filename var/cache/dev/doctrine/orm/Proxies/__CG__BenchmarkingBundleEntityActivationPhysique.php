 ...
 */
class ActivationPhysique extends \BenchmarkingBundle\Entity\ActivationPhysique implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BenchmarkingBundle\\Entity\\ActivationPhysique' . "\0" . 'id', '' . "\0" . 'BenchmarkingBundle\\Entity\\ActivationPhysique' . "\0" . 'image', '' . "\0" . 'BenchmarkingBundle\\Entity\\ActivationPhysique' . "\0" . 'localisation', '' . "\0" . 'BenchmarkingBundle\\Entity\\ActivationPhysique' . "\0" . 'commandePhysique', '' . "\0" . 'BenchmarkingBundle\\Entity\\ActivationPhysique' . "\0" . 'fonctions'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ActivationPhysique $proxy) {
    ...
    public function setCommandePhysique(\BenchmarkingBundle\Entity\CommandePhysique $commandePhysique = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCommandePhysique', [$commandePhysique]);

        return parent::setCommandePhysique($commandePhysique);
    }
    ...
    public function getCommandePhysique()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCommandePhysique', []);

        return parent::getCommandePhysique();
    }
